...
- No automated version-bump tooling — CI only *verifies* the pushed
...
citing a missing sidecar file, that *proves* Step 5's binary placement
...
`libasound`/`libpulse` (the ALSA/PulseAudio *client* libraries — those
